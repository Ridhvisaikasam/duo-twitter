      ...
      <Container maxW={"container.xl"}>
        ...
        >
          ...
          <Box
              ...
              overflowY={'scroll'}
          >
            {realmApp.currentUser&&<Flex flexDirection={'column'} padding={'1rem'}>
                <Heading size={'md'}>Home</Heading>
                <NewTweet updateTweets={updateQuery} />
            </Flex>}
            {realmApp.currentUser&&<Timeline data={data} loading={loading} />}
          </Box>
          <Box padding={"1rem"}>
          {realmApp.currentUser&&<SearchBar />}
          </Box>
        </Grid>
        {!realmApp.currentUser&&<Banner />}
